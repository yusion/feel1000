...
! function() {
        ...
        qq.log = function(a, b) {
                ...
                else for (c in a) if (Object.prototype.hasOwnProperty.call(a, c) && (d = b(c, a[c]), d === !1)) break
...
function() {
...
}(), qq.version = "5.0.8", qq.supportedFeatures = function() {
        "use strict";
        ...
        return h = a(), j = h && qq.isXhrUploadSupported(), i = j && !qq.androidStock(), k = j && b(), l = j && qq.isFileChunkingSupported(), m = j && l && !! window.localStorage, n = j && c(), o = h && (void 0 !== window.postMessage || j), q = d(), p = e(), r = f(), s = g(), t = j && void 0 !== window.FileReader, u = function() {
                return j ? !qq.androidStock() && !qq.iosChrome() : !1
        }(), {
                ajaxUploading: j,
                blobUploading: i,
                canDetermineSize: j,
        ...
        function b() {
                var a = document.createElement("input");
                return a.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, d), e.setMultiple(g.multiple, a), g.folders && qq.supportedFeatures.folderSelection && a.setAttribute("webkitdirectory", ""), g.acceptFiles && a.setAttribute("accept", g.acceptFiles), a.setAttribute("type", "file"), a.setAttribute("name", g.name), qq(a).css({
                        position: "absolute",
                        right: 0,
                        top: 0,
                        fontFamily: "Arial",
...
function() {
        ...
        qq.basePublicApi = {
                addBlobs: function(a, b, c) {
                        ...
                        if (this._maybeHandleIos8SafariWorkaround(), a) {
                                var d = [].concat(a),
                                        e = [],
                                        f = 0 === this._storedIds.length ? qq.getUniqueId() : this._currentBatchId,
                                        g = this;
                                this._currentBatchId = f, qq.each(d, function(a, b) {
                                        ...
                                        } : qq.isObject(b) && b.blob && b.name ? c = b : g.log("addBlobs: entry at index " + a + " is not a Blob or a BlobData object", "error"), c && g._handleNewFile(c, f, e)
                ...
                addFiles: function(a, b, c) {
                        ...
                        var d, e, f, g = [],
                                h = 0 === this._storedIds.length ? qq.getUniqueId() : this._currentBatchId;
                        if (this._currentBatchId = h, a) {
                                for (qq.isFileList(a) || (a = [].concat(a)), d = 0; d < a.length; d += 1) if (e = a[d], qq.isFileOrInput(e)) if (qq.isInput(e) && qq.supportedFeatures.ajaxUploading) for (f = 0; f < e.files.length; f++) this._handleNewFile(e.files[f], h, g);
                                                else this._handleNewFile(e, h, g);
                ...
                uploadStoredFiles: function() {
                        ...
                        else for (; this._storedIds.length;) a = this._storedIds.shift(), this._uploadFile(a)
                }
        }, qq.basePrivateApi = {
                ...
                _createUploadButton: function(a) {
                        function b() {
                                return qq.supportedFeatures.ajaxUploading ? c._options.workarounds.iosEmptyVideos && qq.ios() && !qq.ios6() && c._isAllowedExtension(e, ".mov") ? !1 : void 0 === a.multiple ? c._options.multiple : a.multiple : !1
                        }
                        var c = this,
                ...
                _maybeParseAndSendUploadError: function(a, b, c, d) {
                        if (!c.success) if (d && 200 !== d.status && !c.error) this._options.callbacks.onError(a, b, "XHR returned response code " + d.status, d);
                                else {
                ...
                _maybeProcessNextItemAfterOnValidateCallback: function(a, b, c, d, e) {
                        ...
                        if (b.length > c) if (a || !this._options.validation.stopOnFirstInvalidFile) setTimeout(function() {
                                ...
                                else if (!a) for (; c < b.length; c++) f._fileOrBlobRejected(b[c].id)
                },
...
function() {
        ...
        qq.uiPublicApi = {
                ...
                _addToList: function(a, b, c) {
                        ...
                        if (!f) {
                                if (this._options.display.prependFiles && (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (e = this._filesInBatchAddedToUi - 1), d = {
                                        index: e
                                }), !c && (this._options.disableCancelForFormUploads && !qq.supportedFeatures.ajaxUploading && this._templating.disableCancel(), !this._options.multiple)) {
                                        var g = this.getUploads({
                                                id: a
                                        });
                                        this._handledProxyGroup = this._handledProxyGroup || g.proxyGroupId, g.proxyGroupId === this._handledProxyGroup && g.proxyGroupId || (this._handler.cancelAll(), this._clearList(), this._handledProxyGroup = null)
                                }
                                this._templating.addFile(a, this._options.formatFileName(b), d), c ? this._thumbnailUrls[a] && this._templating.updateThumbnail(a, this._thumbnailUrls[a], !0) : this._templating.generatePreview(a, this.getFile(a)), this._filesInBatchAddedToUi += 1, (c || this._options.display.fileSizeOnSubmit && qq.supportedFeatures.ajaxUploading) && this._displayFileSize(a)
                        }
                },
                _clearList: function() {
        ...
        function c(a, b) {
                ...
                try {
                        var d = b.contentDocument || b.contentWindow.document,
                                f = d.body.innerHTML;
                        h("converting iframe's innerHTML to JSON"), h("innerHTML = " + f), f && f.match(/^<pre/i) && (f = d.body.firstChild.firstChild.nodeValue), c = e._parseJsonResponse(f)
                } catch (g) {
...
function() {
        ...
        function e(c, e, g, h) {
                ...
                if (m.save(), !qq.supportedFeatures.unlimitedScaledImageSize) {
                        ...
                        n && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", k, l, n.newWidth, n.newHeight), "warn"), k = n.newWidth, l = n.newHeight)
                }
                if (f(e, k, l, g.orientation), qq.ios()) {
                        ...
                        for (var r = q.getContext("2d"), s = h ? b(c, i, j) : 1, t = Math.ceil(p * k / i), u = Math.ceil(p * l / j / s), v = 0, w = 0; j > v;) {
                                for (var x = 0, y = 0; i > x;) r.clearRect(0, 0, p, p), r.drawImage(c, -x, -v), m.drawImage(q, 0, 0, p, p, y, w, t, u), x += p, y += t;
                                v += p, w += u
                        }
                        m.restore(), q = r = null
        ...
        g.prototype.render = function(a, b) {
                ...
                "img" === o ? a.src = c(this.srcImage, m, l) : "canvas" === o && e(this.srcImage, a, m, l), "function" == typeof this.onrender && this.onrender(a)
        }, qq.MegaPixImage = g
...
function() {
        ...
        var c = b.getName,
                ...
                i = a.endpointStore,
                j = a.aclStore,
                k = a.objectProperties.reducedRedundancy,
                l = a.objectProperties.serverSideEncryption,
                m = a.validation,
                n = a.signature,
                o = this,
                p = a.signature.credentialsProvider,
                q = {
                        combine: function(a) {
                                var b = o._getPersistableData(a).uploadId,
                                        c = o._getPersistableData(a).etags,
                                        d = new qq.Promise;
                                ...
                                e.success && (d = b.getResponseHeader("ETag"), o._getPersistableData(a).etags || (o._getPersistableData(a).etags = []), o._getPersistableData(a).etags.push({
                                        part: c + 1,
                                        etag: d
                                }))
                        },
                        initHeaders: function(b, c) {
                                var d = {}, e = a.endpointStore.get(b),
                                        ...
                                        g = t.key.urlSafe(b),
                                        h = new qq.Promise,
                                        i = r.restSignature.constructStringToSign(r.restSignature.REQUEST_TYPE.MULTIPART_UPLOAD, f, g).withPartNum(c + 1).withUploadId(o._getPersistableData(b).uploadId);
                                return r.restSignature.getSignature(b + "." + c, {
                                        signatureConstructor: i
                                }).then(function(a) {
                        ...
                        put: function(b, c) {
                                var d = o._createXhr(b, c),
                                        e = o._getChunkData(b, c),
                        ...
                        setup: function(a) {
                                var b = new qq.Promise,
                                        c = o._getPersistableData(a).uploadId,
                                        d = new qq.Promise;
                        ...
                        initParams: function(a) {
                                var b = h.get(a);
                                return b[g] = c(a), qq.s3.util.generateAwsParams({
                                        endpoint: i.get(a),
                                        params: b,
                                        type: o._getMimeType(a),
                                        key: o.getThirdPartyFileId(a),
                                        accessKey: p.get().accessKey,
                                        ...
                                        serverSideEncryption: l,
                                        log: d
                                }, qq.bind(r.policySignature.getSignature, this, a))
                        },
                        send: function(a) {
                                var b = new qq.Promise,
                                        c = o._createXhr(a),
                        ...
                        setup: function(a, b, c) {
                                ...
                                var c = t.response.parse(a, b),
                                        e = c.success !== !0;
                                return e && t.response.shouldReset(c.code) && (d("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), c.reset = !0), {
                                        success: !e,
                                        response: c
                                }
                        },
        ...
        qq.extend(this, {
                ...
                return {
                        expunge: function(b) {
                                var c = o._getPersistableData(b) && o._getPersistableData(b).uploadId,
                                        d = o._maybeDeletePersistedChunkData(b);
        ...
        function c(b, c) {
                ...
                try {
                        ...
                        if (g.bucket === e && g.key === qq.s3.util.encodeQueryStringParam(h.getThirdPartyFileId(b))) return !0;
        ...
        function d(a) {
                var b = o.get(a);
                return b[n] = j(a), qq.s3.util.generateAwsParams({
                        endpoint: p.get(a),
                        params: b,
                        key: h.getThirdPartyFileId(a),
                        accessKey: w.get().accessKey,
                        sessionToken: w.get().sessionToken,
                        acl: q.get(a),
                        minFileSize: t.minSizeLimit,
                        maxFileSize: t.maxSizeLimit,
                        successRedirectUrl: v,
                        reducedRedundancy: r,
                        serverSideEncryption: s,
                        log: l
                }, qq.bind(x.getSignature, this, a))
        }
        function e(b, c) {
                var e = new qq.Promise,
        ...
        var h = this,
                ...
                p = a.endpointStore,
                q = a.aclStore,
                r = a.objectProperties.reducedRedundancy,
                s = a.objectProperties.serverSideEncryption,
                t = a.validation,
                u = a.signature,
                v = a.iframeSupport.localBlankPagePath,
                w = a.signature.credentialsProvider,
...
function() {
        ...
        function c(a) {
                ...
                return e(a).then(function(c) {
                        var d = g._getMimeType(a),
                                e = g._getPersistableData(a).blockIdEntries;
        ...
        function e(a, b) {
                var c = null == b ? a : a + "." + b,
                        ...
                        f = function(a) {
                                ...
                                h("GET SAS request failed: " + a, "error"), e.failure({
                                        error: "Problem communicating with local server"
                                }, b)
                        }, i = function(a) {
                                t.getSasForPutBlobOrBlock.request(c, a).then(f, g)
                        }, j = function(b) {
                                h(qq.format("Failed to determine blob name for ID {} - {}", a, b), "error"), e.failure({
                                        error: b
                                })
                        };
        ...
        function f(a, b) {
                var c = qq.azure.util.parseAzureError(a.responseText, h),
                        d = "Problem sending file to Azure";
                b.failure({
                        error: d,
                        azureError: c && c.message,
                        reset: 403 === a.status
                })
        }
        var g = this,
        ...
        qq.extend(this, {
                uploadChunk: function(a, b) {
                        var c = new qq.Promise;
                        return e(a, b).then(function(d) {
                                var e = g._createXhr(a, b),
                                        i = g._getChunkData(a, b);
                ...
                return {
                        expunge: function(b) {
                                var c = g._wasCanceled(b),
                                        d = g._getPersistableData(b),
                                        e = d && d.blockIdEntries || [];
        ...
        qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({
                ...
                method: c,
                upload: function(a, c, g, h) {
                        var i = new qq.Promise;
                        return d.log("Submitting Put Blob request for " + a), f[a] = i, e[a] = g, b.initTransport(a).withPayload(h).withHeaders({
                                "Content-Type": h.type
                        }).send(c), i
                }
        })
        ...
        qq.extend(f, a), c = qq.extend(this, new qq.AjaxRequester({
                ...
                method: d,
                send: function(a, d, h, i, j) {
                        var k, l = new qq.Promise,
                                m = b(h);
                        return e[a] = l, f.log(qq.format("Submitting Put Block List request for {}", a)), g[a] = qq.format("{}&comp=blocklist", d), k = c.initTransport(a).withPayload(m).withHeaders({
                                "x-ms-blob-content-type": i
                        }).send(), j(k), l
                }
        })
        ...
        qq.extend(g, a), c = qq.extend(this, new qq.AjaxRequester({
                validMethods: [d],
                method: d,
                successfulResponseCodes: function() {
                        var a = {};
                ...
                method: d,
                upload: function(a, d, i, j, k) {
                        var l = new qq.Promise,
                                m = b(j);
                        return f[a] = l, g.log(qq.format("Submitting Put Block request for {} = part {}", a, j)), h[a] = qq.format("{}&comp=block&blockid={}", i, encodeURIComponent(m)), e[a] = {
                                part: j,
                                id: m
                        }, c.initTransport(a).withPayload(k).send(d), l
                }
        })
},
function() {
        ...
        d.Base64 = {
                stringify: function(a) {
                        var b = a.words,
                                ...
                                d = this._map;
                        a.clamp();
                        for (var e = [], f = 0; c > f; f += 3) for (var g = 255 & b[f >>> 2] >>> 24 - 8 * (f % 4), h = 255 & b[f + 1 >>> 2] >>> 24 - 8 * ((f + 1) % 4), i = 255 & b[f + 2 >>> 2] >>> 24 - 8 * ((f + 2) % 4), j = g << 16 | h << 8 | i, k = 0; 4 > k && c > f + .75 * k; k++) e.push(d.charAt(63 & j >>> 6 * (3 - k)));
                        var l = d.charAt(64);
                ...
                parse: function(a) {
                        ...
                        for (var g = [], h = 0, i = 0; b > i; i++) if (i % 4) {
