%for index,r in enumerate(result):
	...
	%end
<div class="col-md-6 search_item_css panel2_css">
	...
	<div class="search_item_btn_css">
		<a><strong><i class="icon-heart-empty" ></i></strong></a>
		<div class="btn-group search_item_dislike_btn_css">
